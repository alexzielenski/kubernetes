...
require (
	...
	k8s.io/kube-openapi v0.0.0-20240223233029-649db6989aae
...
replace k8s.io/kube-openapi => github.com/alexzielenski/kube-openapi v0.0.0-20240223233029-649db6989aae
